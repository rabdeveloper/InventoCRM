        ...
        <v-card dark class="pt-3">
            <v-layout row wrap>
                <v-flex xs12 sm4 class="px-2">
                    <v-btn @click="$router.push({name:'product.create'})" class="blue lighten-1" dark>
                        Add Product
    ...
    export default {
        ...
        methods: {
            trash(user) {
                ...
                self.$store.commit('showDialog',{
                    ...
                    okCb: ()=>{
                        ...
                        axios.delete('/admin/product/' + user.id).then(function(response) {
            ...
            loadProducts(cb) {
                ...
                axios.get('/admin/product',{params: params}).then(function(response) {
